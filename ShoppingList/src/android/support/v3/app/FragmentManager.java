...
final class FragmentManagerImpl extends FragmentManager {
    ...
    //v3 static final boolean HONEYCOMB = android.os.Build.VERSION.SDK_INT >= 11;
    static boolean HONEYCOMB = false; // android.os.Build.VERSION.SDK_INT >= 11;
    
    static {
    	HONEYCOMB = VersionUtils.getAndroidSDKLevel() >= 11;
    }
