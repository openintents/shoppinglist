...
public class FragmentActivity extends Activity {
    //v3 Cupcake compatibility
    public static int SDK_INT = 3;
    static {
    	SDK_INT = VersionUtils.getAndroidSDKLevel();
    }
    ...
    public boolean onCreatePanelMenu(int featureId, Menu menu) {
        if (featureId == Window.FEATURE_OPTIONS_PANEL) {
            ...
            //v3 if (android.os.Build.VERSION.SDK_INT >= HONEYCOMB) {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        //v3 if (android.os.Build.VERSION.SDK_INT < 5 /* ECLAIR */
        if (SDK_INT < 5 /* ECLAIR */
